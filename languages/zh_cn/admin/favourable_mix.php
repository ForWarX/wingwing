...
/* menu */
$_LANG['favourable_list'] = '优惠活动(混搭)列表';
$_LANG['add_favourable'] = '添加优惠活动(混搭)';
$_LANG['edit_favourable'] = '编辑优惠活动(混搭)';
$_LANG['favourable_log'] = '优惠活动(混搭)出价记录';
$_LANG['continue_add_favourable'] = '继续添加优惠活动(混搭)';
$_LANG['back_favourable_list'] = '返回优惠活动(混搭)列表';
$_LANG['add_favourable_ok'] = '添加优惠活动(混搭)成功';
$_LANG['edit_favourable_ok'] = '编辑优惠活动(混搭)成功';

/* list */
$_LANG['act_is_going'] = '仅显示进行中的活动';
$_LANG['act_name'] = '优惠活动(混搭)名称';
$_LANG['goods_name'] = '商品名称';
$_LANG['start_time'] = '开始时间';
$_LANG['end_time'] = '结束时间';
$_LANG['min_amount'] = '金额下限';
$_LANG['max_amount'] = '金额上限';
$_LANG['favourable_not_exist'] = '您要操作的优惠活动(混搭)不存在';
$_LANG['js_languages']['batch_drop_confirm'] = '您确实要删除选中的优惠活动(混搭)吗？';
$_LANG['batch_drop_ok'] = '批量删除成功';
$_LANG['no_record_selected'] = '没有选择记录';

/* info */
$_LANG['label_act_name'] = '优惠活动(混搭)名称：';
...
$_LANG['js_languages']['act_name_not_null'] = '请输入优惠活动(混搭)名称';
...
$_LANG['act_name_exists'] = '该优惠活动(混搭)名称已存在，请您换一个';
