...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('article_cat')."(cat_name, cat_name_en, cat_type, cat_desc, cat_desc_en, keywords, parent_id, sort_order, show_in_nav)
           VALUES ('$_POST[cat_name]', '$_POST[cat_name_en]', '$cat_type',  '$_POST[cat_desc]',  '$_POST[cat_desc_en]', '$_POST[keywords]', '$_POST[parent_id]', '$_POST[sort_order]', '$_POST[show_in_nav]')";
    $db->query($sql);
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT cat_id, cat_name, cat_name_en, cat_type, cat_desc, cat_desc_en, show_in_nav, keywords, parent_id,sort_order FROM ".
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    $dat = $db->getAll("SELECT cat_name, show_in_nav FROM ". $ecs->table('article_cat') . " WHERE cat_id = '" . $_POST['id'] . "'");
    if ($exc->edit("cat_name = '$_POST[cat_name]', cat_name_en = '$_POST[cat_name_en]', cat_desc ='$_POST[cat_desc]', cat_desc_en ='$_POST[cat_desc_en]', keywords='$_POST[keywords]',parent_id = '$_POST[parent_id]', cat_type='$cat_type', sort_order='$_POST[sort_order]', show_in_nav = '$_POST[show_in_nav]'",  $_POST['id']))
    {
