...
function addToCart1(goodsId, parentId, xpbuy)
{
 ...
 quick = 1;
  ...
  goods.xpbuy	 = (typeof(xpbuy) == "undefined") ? 0 : parseInt(xpbuy);
...
{
  Ajax.call('comment.php?act=gotopage', 'page=' + page + '&id=' + id + '&type=' + type + '&active_tab=' + document.getElementById('active_tab').value, gotoPageResponse, 'GET', 'JSON');
}
