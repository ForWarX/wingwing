...
$_LANG['search'] = '搜索';
$_LANG['wholesale_search'] = '搜索B2B商品';
...
$_LANG['use_surplus'] = '使用小熊卡';
$_LANG['your_surplus'] = '您的小熊卡余额为';
$_LANG['pay_fee'] = '支付手续费';
...
/* 批发部分语言项 */
$_LANG['ws_user_rank'] = '您的等级暂时无法查看B2B方案';
$_LANG['ws_login_please'] = '请您先登录';
$_LANG['ws_return_home'] = '返回首页';
$_LANG['wholesale'] = 'B2B专区';
$_LANG['no_wholesale'] = '没有B2B商品';
$_LANG['ws_price'] = 'B2B价';
$_LANG['ws_subtotal'] = '小计';
$_LANG['ws_invalid_goods_number'] = '请输入正确的数量';
$_LANG['ws_attr_not_matching'] = '您选择的商品属性不存在，请参照B2B价格单选择';
$_LANG['ws_goods_number_not_enough'] = '您购买的数量没有达到B2B的最小数量，请参照B2B价格单';
$_LANG['ws_goods_attr_exists'] = '该商品已经在购物车中，不能再次加入';
$_LANG['ws_remark'] = '请填写您的备注信息（如配送方式等）';
...
$_LANG['passport_js']['msg_un_blank'] = '<i class=\"glyphicon glyphicon-remove-sign\"></i> 用户名不能为空';
$_LANG['passport_js']['msg_un_length'] = '<i class=\"glyphicon glyphicon-remove-sign\"></i> 用户名最长不得超过7个汉字';
$_LANG['passport_js']['msg_un_format'] = '<i class=\"glyphicon glyphicon-remove-sign\"></i> 用户名含有非法字符';
$_LANG['passport_js']['msg_un_registered'] = '* 用户名已经存在,请重新输入';
$_LANG['passport_js']['msg_can_rg'] = '<i class=\"glyphicon glyphicon-ok-sign\"></i> 可以注册';
$_LANG['passport_js']['msg_email_blank'] = '<i class=\"glyphicon glyphicon-remove-sign\"></i> 邮件地址不能为空';
$_LANG['passport_js']['msg_email_registered'] = '<i class=\"glyphicon glyphicon-remove-sign\"></i> 邮箱已存在,请重新输入';
...
$_LANG['p_y']['link_start'] = '<a href="http://www.pbcc.ca" target="_blank" style=" font-family:Verdana; font-size:11px;">';
...
$_LANG['user_balance'] = '小熊卡余额';
$_LANG['wholesale_goods_cart'] = 'B2B商品购物车';
$_LANG['wholesale_goods_list'] = 'B2B商品列表';
...
/// goods.dwt //
$_LANG['goods_related_h3'] = '相关产品';
$_LANG['goods_spec_h3'] = '产品属性';
$_LANG['goods_desc_h3'] = '产品描述';
