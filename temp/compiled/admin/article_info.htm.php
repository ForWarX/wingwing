...
<div class="tab-div">
  ...
  <div id="tabbody-div">
    ...
    <table width="90%" id="general-table">
	  ...
	  <tr>
		  <td class="narrow-label"><?php echo $this->_var['lang']['lable_date']; ?></td>
		  <td><input name="article_date" type="text" id="article_date" size="12" value='<?php echo $this->_var['article']['article_date']; ?>' readonly /><input name="selbtn1" type="button" id="selbtn1" onclick="return showCalendar('article_date', '%Y-%m-%d', false, false, 'selbtn1');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/></td>
	  </tr>
      <tr>
