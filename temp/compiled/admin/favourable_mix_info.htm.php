...
<div class="main-div">
<form method="post" action="favourable_mix.php" name="theForm" enctype="multipart/form-data" onSubmit="return validate()">
<table cellspacing="1" cellpadding="3" width="100%">
  <tr>
    <td class="label"><?php echo $this->_var['lang']['label_act_name']; ?></td>
    <td><input name="act_name" type="text" id="act_name" value="<?php echo $this->_var['favourable']['act_name']; ?>" size="40" /></td>
  </tr>
  <tr>
    <td class="label"><?php echo $this->_var['lang']['label_start_time']; ?></td>
    <td><input name="start_time" type="text" id="start_time" value="<?php echo $this->_var['favourable']['start_time']; ?>" readonly />
  ...
  <tr>
    ...
    <td><input name="end_time" type="text" id="end_time" value="<?php echo $this->_var['favourable']['end_time']; ?>" readonly />
...
?><input type="checkbox" name="user_rank[]" value="<?php echo $this->_var['user_rank']['rank_id']; ?>" <?php if ($this->_var['user_rank']['checked']): ?>checked="true"<?php endif; ?> /><?php echo $this->_var['user_rank']['rank_name']; ?> <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></td>
  </tr>
  <tr>
...
?><input name="act_range_ext[]" type="checkbox" value="<?php echo $this->_var['item']['id']; ?>" checked="checked" /><?php echo $this->_var['item']['name']; ?> <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></div></td>
  ...
  <tr>
    <td class="label">数量下限</td>
    <td><input name="min_quantity" type="text" id="min_quantity" value="<?php echo $this->_var['favourable']['min_quantity']; ?>"></td>
  </tr>
  <tr>
    <td class="label">数量上限</td>
    <td><input name="max_quantity" type="text" id="max_quantity" value="<?php echo $this->_var['favourable']['max_quantity']; ?>">
...
function searchItem()
{
  ...
  Ajax.call('favourable_mix.php?is_ajax=1&act=search', filter, searchResponse, 'GET', 'JSON');
}
...
function searchItem1()
{
  ...
  filter.act_range = 3;
  Ajax.call('favourable_mix.php?is_ajax=1&act=search', filter, searchResponse1, 'GET', 'JSON');
}
