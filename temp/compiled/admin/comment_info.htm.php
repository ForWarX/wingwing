...
<?php if ($this->_var['reply_info']): ?>
<!-- <?php $_from = $this->_var['reply_info']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'reply');if (count($_from)):
    foreach ($_from AS $this->_var['reply']):
?> -->
<!-- reply content list -->
<div class="" id="reply_<?php echo $this->_var['reply']['comment_id']; ?>">
  <table width="100%" style="padding:1px;">
     <tr>
      <td colspan="3"><hr color="#dadada" size="1"></td>
    </tr>
    <tr>
      <td>
      <?php if ($this->_var['reply']['is_admin'] == 1): ?><font style="color:#EF5A2C;"><?php echo $this->_var['lang']['admin_user_name']; ?>&nbsp;<a href="mailto:<?php echo $this->_var['msg']['email']; ?>" style="<?php if ($this->_var['reply']['is_admin'] == 1): ?>color:#EF5A2C;<?php endif; ?>"><b><?php echo $this->_var['reply']['user_name']; ?></b></a>&nbsp;<?php echo $this->_var['lang']['from']; ?>
      &nbsp;<?php echo $this->_var['reply']['add_time']; ?>&nbsp;<?php echo $this->_var['lang']['reply']; ?></font><?php else: ?><a href="mailto:<?php echo $this->_var['msg']['email']; ?>"><b><?php echo $this->_var['reply']['user_name']; ?></b></a>&nbsp;<?php echo $this->_var['lang']['from']; ?>
      &nbsp;<?php echo $this->_var['reply']['add_time']; ?>&nbsp;<?php echo $this->_var['lang']['reply']; ?><?php endif; ?>
    </td>
    <td>
    </td>
    <td style="text-align:right;">
		<a href="javascript:" onclick="remove_comment(<?php echo $this->_var['reply']['comment_id']; ?>, '您确认要删除这条记录吗?')">移除</a>
    </td>
    </tr>
    <tr>
      <td colspan="3">
        <div style="overflow:hidden; word-break:break-all;"><?php if ($this->_var['reply']['is_admin'] == 1): ?><font style="color:#EF5A2C;"><?php echo $this->_var['reply']['content']; ?></font><?php else: ?><?php echo $this->_var['reply']['content']; ?><?php endif; ?></div>
        <div align="right"><b><?php echo $this->_var['lang']['ip_address']; ?></b>: <?php echo $this->_var['reply']['ip_address']; ?></div>
      </td>
    </tr>
  </table>
</div>
...
<table border="0" align="center">
  ...
  <tr>
    ...
    <td>
      ...
      <input type="hidden" name="parent_id" value="<?php echo $this->_var['msg']['comment_id']; ?>">
...
function remove_comment(commentId,confirmMsg){
	if (confirm(confirmMsg) === true){
		Ajax.call('comment_manage.php', 'act=remove_ajax&ajax_comment_id=' + commentId, commentResponse, 'POST', 'JSON');
	}
}
function commentResponse(result){
	if(result.result == '1'){
		var removeId = "reply_" + result.id;
