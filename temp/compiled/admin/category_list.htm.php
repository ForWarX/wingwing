...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    ...
    <td width="3%"><img src="images/<?php if ($this->_var['cat']['show_in_nav'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_show_in_nav', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
    <td width="3%"><img src="images/<?php if ($this->_var['cat']['is_show'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_is_show', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
	...
	<td width="3%"><img src="images/<?php if ($this->_var['cat']['is_event_area'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_is_event_area', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>	
	<td width="3%"><img src="images/<?php if ($this->_var['cat']['show_banner_in_home_page'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_show_banner_in_home_page', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
	<td width="3%"><img src="images/<?php if ($this->_var['cat']['show_banner_in_category_page'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_show_banner_in_category_page', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
    <td width="24%" align="center">
	  <a href="../category.php?id=<?php echo $this->_var['cat']['cat_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="images/icon_view.gif" width="16" height="16" border="0" /></a>
