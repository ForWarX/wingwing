...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/transport_modified.js,common.js,../js/jquery.min.js,../js/json2.js')); ?>


<?php echo $this->smarty_insert_scripts(array('files'=>'../js/vertical_nav.js')); ?>
