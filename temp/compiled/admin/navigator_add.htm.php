...
<tr>
    <td><?php echo $this->_var['lang']['item_en_name']; ?></td> <td><input type="text" name="item_en_name" value="<?php echo $this->_var['rt']['item_en_name']; ?>" id="item_en_name" size="40" onKeyPress="javascript:key();" /></td>
</tr>
<tr>
    <td><?php echo $this->_var['lang']['item_cht_name']; ?></td> <td><input type="text" name="item_cht_name" value="<?php echo $this->_var['rt']['item_cht_name']; ?>" id="item_cht_name" size="40" onKeyPress="javascript:key();" /></td>
</tr>
<tr>
