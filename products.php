...
if (!$smarty->is_cached('goods.dwt', $cache_id))
{
	...
	/*分类馆*/
	$cat_info_list = $db->getAll("SELECT * FROM ". $ecs->table("category") . " WHERE parent_id = 0 AND show_banner_in_home_page = 1 ORDER BY sort_order ASC LIMIT 10");
...
$smarty->display('products.dwt', $cache_id);
